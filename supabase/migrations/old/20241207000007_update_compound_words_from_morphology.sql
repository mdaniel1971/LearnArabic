-- Migration: Update compound words from Quranic Arabic Corpus morphology data
-- Date: 2024-12-07
-- Description: Updates grammar_info for surahs 97-114 to properly identify and store compound words
--              (noun+pronoun and verb+pronoun combinations) with detailed pronoun and verb information
...
--
-- This migration:
-- 1. Identifies compound words (noun_pronoun, verb_pronoun)
-- 2. Extracts pronoun details (person, number, gender) from suffixes
-- 3. Extracts verb details (form, aspect, voice, tense, person, mood) from stems
-- 4. Updates grammar_info JSONB column with structured compound word data
